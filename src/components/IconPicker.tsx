...
const EMOJI_GROUPS = {
  People_And_Faces: ["😀", "😃", "😄", "😁", "😆", "😅", "😂", "🤣", "🙂", "🙃", "😉", "😊", "😇", "😍", "😘", "🤗", "🤩", "🤔", "👩‍🦱", "👨‍🦳", "👩‍🦳", "👨‍🦲", "👩‍🦲", "🧔", "👩‍🚀", "👨‍✈️", "👩‍✈️", "👨‍🚒", "👩‍🚒"],
  Animals: ["🐶", "🐱", "🐭", "🐹", "🐰", "🦊", "🐻", "🐼", "🐨", "🐯", "🦁", "🐮", "🐷", "🐸", "🐵", "🦄", "🐢", "🐍", "🦖", "🦕", "🐙", "🦑", "🐠", "🐟", "🐬", "🦜", "🦩", "🦔", "🦇", "🦉"],
  Food_And_Drink: ["🍎", "🍐", "🍊", "🍋", "🍌", "🍉", "🍇", "🍓", "🫐", "🍈", "🍒", "🍑", "🥭", "🍍", "🥥", "🥑", "🥕", "🥦", "🌽", "🌶️", "🥬", "🥒", "🧄", "🧅", "🍞", "🥐", "🥖", "🧀", "🍗", "🍖"],
  Activities_And_Sports: ["🎨", "🖌️", "🎭", "🎤", "🎼", "🎹", "🥁", "🎷", "🎺", "🎸", "🎮", "🕹️", "🏀", "🏈", "⚽", "🎾", "🏐", "🏓", "🏸", "🥊", "🥋", "🎯", "🎳", "🛷", "🏹", "🎣", "⛷️", "🏂", "🏆"],
  Travel_And_Transport: ["🌍", "✈️", "🚗", "🚕", "🚙", "🚌", "🏎️", "🚓", "🚑", "🚒", "🚚", "🚜", "🚲", "🛵", "🏍️", "🚂", "🚆", "🚊", "🚉", "🚀", "🛸", "⛵", "🚢", "🛳️", "🚤", "🛶", "🚁", "🗺️", "🧭"],
  Objects_And_Tools: ["🔧", "🔨", "⚒️", "🛠️", "⛏️", "🔩", "⚙️", "🔗", "💡", "🔦", "🕯️", "📶", "🔌", "🔋", "🔑", "🗝️", "🔏", "🔐", "📜", "📄", "📒", "🗂️"],
  Flags: ["🏳️", "🏴", "🏴‍☠️", "🏁", "🚩", "🏳️‍🌈", "🇻🇳", "🇺🇸", "🇬🇧", "🇯🇵", "🇰🇷", "🇨🇳", "🇩🇪", "🇫🇷", "🇮🇹", "🇪🇸", "🇵🇹", "🇳🇱", "🇧🇪", "🇨🇭", "🇦🇹", "🇨🇿", "🇵🇱", "🇭🇺", "🇷🇴", "🇬🇷"],
  AI_And_Tech: ["🤖", "🦾", "🦿", "🧠", "📡", "🌐", "🧮", "🤯", "💾", "💿", "📀", "⚡", "🔬", "📊", "📈", "📉", "🔍", "🧩"]
};
...
const IconPicker: React.FC<IconPickerProps> = ({ selected, onSelect }) => {
  ...
  const [activeGroup, setActiveGroup] = useState<keyof typeof EMOJI_GROUPS>("People_And_Faces");
    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2 overflow-x-auto pb-2">
        {Object.keys(EMOJI_GROUPS).map(group => (
          ...
          >
            {group.replace(/_/g, ' ').replace(/And/g, '&')}
          </button>
        ))}
      </div>
